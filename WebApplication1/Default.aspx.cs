...
namespace WebApplication1
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            string credentials = Convert.ToBase64String(System.Text.ASCIIEncoding.ASCII.GetBytes(string.Format("{0}:{1}", "", "folqffoyta3rrrcxqnkq4en2kaujh4n7zo7sq3ex5dl23rmnaekq")));
            ...
            hwr.Method = "POST";
            hwr.Headers.Set("Authorization", "Bearer " + credentials);
